...
import { Flame, TrendingUp, TrendingDown, Minus, MessageSquare, ArrowUp } from 'lucide-react';
...
export default function RightSidebar() {
  ...
  return (
    <aside className="hidden xl:block w-80 h-[calc(100vh-4rem)] sticky top-16 py-6 pr-6 overflow-y-auto">
            ...
            {popularQuestions.map((question) => (
              ...
              >
                <div className="flex items-start gap-2">
                  {question.isHot && (
                    <span className="flex-shrink-0 px-1.5 py-0.5 text-[10px] font-bold uppercase bg-[var(--color-primary-500)] text-white rounded">
                      Hot
                    </span>
                  )}
